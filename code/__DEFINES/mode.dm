...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_RMC,s SQUAD_LRRP))
...
GLOBAL_LIST_INIT(ROLES_AI_RMC, list(JOB_SQUAD_MARINE_RMC, JOB_SQUAD_SMARTGUN_RMC, JOB_SQUAD_TEAM_LEADER_RMC, JOB_SQUAD_LEADER_RMC, JOB_SO_RMC,))
